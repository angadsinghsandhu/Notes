# ================================================================
# File: vendingmachine/vending_machine.py
# Description:
#   The main VendingMachine class representing the vending machine.
#   - Follows the Singleton pattern to ensure only one instance.
#   - Manages current state, selected product, total payment, and inventory.
...
# 9. Apply Design Patterns (Singleton, State) and SOLID principles.
# ================================================================
    ...
    def __new__(cls):
        with cls._lock:
            if cls._instance is None:
                ...
                # Initialize inventory and states.
