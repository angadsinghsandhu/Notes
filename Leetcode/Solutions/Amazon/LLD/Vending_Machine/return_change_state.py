# ================================================================
# File: vendingmachine/return_change_state.py
# Description:
#   Implements the ReturnChangeState behavior.
#   - In ReturnChangeState, the product has been dispensed and the machine is returning change.
#   - Calculates and returns change, resets state, and returns to IdleState.
#
# Steps Covered:
