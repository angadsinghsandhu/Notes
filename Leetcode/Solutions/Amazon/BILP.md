...
### **Result**  
The implementation of the Sentiment Analysis Bot reduced the compliance response time by 50%, allowing for quicker reactions to market trends and customer concerns. Furthermore, the system established a closed-loop pipeline that continuously improved as new data was processed, ensuring ongoing efficiency and accuracy in handling Twitter queries.
...
At Johns Hopkins Medicine, I’m currently fine-tuning multimodal LLMs using instruct-tuning and reinforcement learning from human feedback. I have reduced training compute requirements by 65% through the use of DeepSpeed, Accelerate, and high-performance cluster scheduling. This work is part of an initiative to develop cutting-edge educational tools that provide personalized feedback to medical professionals, ultimately enhancing clinical outcomes in high-stakes environments. Before this, I spearheaded the development of an AI-powered financial chatbot at ShareKhan by BNP Paribas, implementing GPT-style models that enhanced how users interact with financial data. I also built a healthcare policy management platform at Optum that successfully served over 10,000 clients, showcasing my ability to deliver scalable, real-world solutions.
...
Looking ahead, I’m excited to tackle complex AI challenges and help democratize machine learning by making advanced AI tools accessible to all and help empower even those who are not well-versed in tech. I envision a future where advanced AI not only drives technological innovation but also creates tangible, positive societal impact. I’m eager to bring my blend of research, development, and leadership experience to Amazon, where I can contribute to transformative projects and help shape the future of technology.

## **Why Amazon?**

Johns Hopkins University and Amazon have collaborated to help advance AI research and bridge the gap between industry and academia in an initiative known as AI2AI. At a recent AI2AI event at Hopkins, I had the opportunity to discuss cutting-edge AI research with Grant Stiemel, Principal Scientist at Amazon AI. His insights into Amazon’s work in large-scale AI optimizations, multimodal learning, and reinforcement learning and excitement about further technological advancements in the field resonated deeply with my own research and professional interests. The collaboration also clearly showcased how Amazon fosters innovation and encourages curiosity, which reinforces my desire to contribute to Amazon’s AI ecosystem.

  
As a loyal Amazon customer, I've experienced firsthand the high standards and customer-centric mindset that define your brand. As a passionate CS engineer, the sheer scope and scalability of Amazon's technical services is inspiring. Platforms like SageMaker, Inuit, and even Slack’s AI-powered features run on Amazon’s robust infrastructure, and I am fascinated by the engineering prowess behind these systems. It would be an incredible opportunity to contribute to the systems that form the backbone of so many innovative applications.

Amazon’s leadership in large language models, reinforcement learning, and scalable ML pipelines provides the ideal platform for me to drive advancements in scalable AI inference, and multimodal learning. I see myself leveraging my expertise to enhance Amazon’s AI-driven products and contribute to the development of highly advanced systems. Amazon’s commitment to AI inference and scalable machine learning pipelines aligns perfectly with my background and career trajectory, and I am excited about the prospect of enhancing Amazon’s products while continuously growing as an engineer and innovator.
